<?php // $file = C:/xampp/htdocs/wordpress/wp-content/themes/yootheme/packages/builder/elements/section/element.json
...
return [
  ...
  'fields' => [
    ...
    'height' => [
      'label' => 'Height', 
      'description' => 'Setting viewport height on a section that directly follows the header will subtract the header height from it. On short pages, a section can be expanded to fill the viewport.', 
      'type' => 'select', 
      'options' => [
        'None' => '', 
        'Viewport' => 'full', 
        ...
        'Expand' => 'expand', 
        '2 Viewports' => 'viewport-2', 
        '3 Viewports' => 'viewport-3', 
        '4 Viewports' => 'viewport-4'
      ]
    ], 
    'vertical_align' => [
  ...
  'fieldset' => [
    'default' => [
      ...
      'fields' => [[
          ...
          'title' => 'Settings', 
          'fields' => ['style', 'preserve_color', 'overlap', 'text_color', 'width', 'padding_remove_horizontal', 'width_expand', 'height', 'vertical_align', 'padding', 'padding_remove_top', 'padding_remove_bottom', 'html_element', 'sticky', 'header_transparent', 'header_transparent_noplaceholder', 'animation', 'animation_delay', [
              'label' => 'Title', 
              'type' => 'group', 
      ...
      'fieldset' => [
        'default' => [
          'fields' => [[
            ...
            ], 'image_focal_point', 'image_loading', 'image_size', 'image_position', 'image_effect', 'image_parallax_bgx', 'image_parallax_bgy', '_image_parallax_description', 'image_parallax_easing', 'image_parallax_breakpoint', [
