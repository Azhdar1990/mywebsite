<?php // $file = C:/xampp/htdocs/wordpress/wp-content/themes/yootheme/packages/theme/config/customizer.json
    ...
    'site' => [
      ...
      'fields' => [
        ...
        'site.boxed.header_transparent' => [
          ...
          'description' => 'Make the header background transparent.', 
          'type' => 'select', 
          'options' => [
            'None' => '', 
            'Light Text' => 'light', 
          ...
          'enable' => 'site.layout == \'boxed\' && site.boxed.header_outside && !header.transparent'
        ], 
        'site.toolbar_width' => [
          'label' => 'Toolbar', 
          'type' => 'select', 
