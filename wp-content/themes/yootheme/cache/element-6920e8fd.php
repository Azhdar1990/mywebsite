<?php // $file = C:/xampp/htdocs/wordpress/wp-content/themes/yootheme/packages/builder/elements/overlay-slider_item/element.json
...
return [
  ...
  'fieldset' => [
    'default' => [
      ...
      'fields' => [[
          'title' => 'Content', 
          'fields' => ['image', 'video', '_media', 'image_alt', 'title', 'meta', 'content', 'link', 'link_text', 'link_aria_label', 'hover_image']
        ], [
          'title' => 'Settings', 
          'fields' => [[
              'label' => 'Item', 
