<?php // $file = C:/xampp/htdocs/wordpress/wp-content/themes/yootheme/packages/builder/elements/row/element.json
...
return [
  ...
  'fields' => [
    ...
    'height' => [
      'label' => 'Column Height', 
      'description' => 'Set the height for all columns. They will keep their height when stacking. Setting viewport height on a row that directly follows the header will subtract the header height from it.', 
      'type' => 'select', 
      'options' => [
        'None' => '', 
        'Viewport' => 'full', 
  ...
  'fieldset' => [
    'default' => [
      ...
      'fields' => [[
          'title' => 'Settings', 
          'fields' => ['layout', '_layout', 'columns', 'column_gap', 'row_gap', 'divider', 'alignment', 'width', 'padding_remove_horizontal', 'width_expand', 'height', 'margin', 'margin_remove_top', 'margin_remove_bottom', 'match', 'html_element', 'parallax', [
