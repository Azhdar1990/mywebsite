<?php // $file = C:/xampp/htdocs/wordpress/wp-content/themes/yootheme/packages/builder/elements/list/element.json
    ...
    'default' => [
      ...
      'fields' => [[
          ...
          'fields' => [[
              ...
              'type' => 'group', 
              'divider' => true, 
              'fields' => ['list_type', 'list_marker', 'list_marker_color', 'list_style', 'list_size', 'list_horizontal_separator', 'column', 'column_divider', 'column_breakpoint', 'list_element']
            ], [
              'label' => 'Content', 
              'type' => 'group', 
              'divider' => true, 
