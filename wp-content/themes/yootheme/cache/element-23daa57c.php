<?php // $file = C:/xampp/htdocs/wordpress/wp-content/themes/yootheme/packages/builder/elements/map/element.json
...
return [
  ...
  'fields' => [
    ...
    'poi' => [
      ...
      'show' => 'this.Config.values.google_maps'
    ], 
    'zooming' => [
      'type' => 'checkbox', 
    ...
    'default' => [
      ...
      'fields' => [[
          ...
          'fields' => [[
              ...
              'type' => 'group', 
              'divider' => true, 
              'fields' => ['type', 'zoom', 'controls', 'poi', 'zooming', 'dragging', 'min_zoom', 'max_zoom', 'viewport_height', 'height', 'width', 'width_breakpoint']
            ], [
              'label' => 'Style', 
