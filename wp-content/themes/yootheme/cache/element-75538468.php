<?php // $file = C:/xampp/htdocs/wordpress/wp-content/themes/yootheme/packages/builder/elements/panel-slider/element.json
    ...
    'default' => [
      ...
      'fields' => [[
          ...
          'fields' => [[
              ...
              'type' => 'group', 
              'divider' => true, 
              'fields' => ['panel_style', 'panel_card_offset', 'panel_card_match', 'panel_link', 'panel_padding', 'panel_image_no_padding']
            ], [
              'label' => 'Title', 
              'type' => 'group', 
              'divider' => true, 
              ...
              'fields' => [[
                ...
                ], 'image_loading', 'image_border', 'image_link', 'image_transition', 'icon_width', 'icon_color', 'image_align', 'image_grid_width', 'image_grid_column_gap', 'image_grid_row_gap', 'image_grid_breakpoint', 'image_vertical_align', 'image_margin', 'image_svg_inline', 'image_svg_animate', 'image_svg_color']
            ], [
              'label' => 'Link', 
              'type' => 'group', 
              'divider' => true, 
