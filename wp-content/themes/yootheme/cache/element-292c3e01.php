<?php // $file = C:/xampp/htdocs/wordpress/wp-content/themes/yootheme/packages/builder/elements/image/element.json
...
return [
  ...
  'fields' => [
    ...
    'image_viewport_height' => [
      ...
      'description' => 'Force the height to one viewport. The image will cover the element\'s content box.', 
      'type' => 'checkbox', 
    ...
    'default' => [
      ...
      'fields' => [[
          ...
          'fields' => [[
              ...
              'type' => 'group', 
              'divider' => true, 
              'fields' => ['image_focal_point', 'image_loading', 'image_border', 'image_box_shadow', 'image_hover_box_shadow', 'image_box_decoration', 'image_box_decoration_inverse', 'image_svg_inline', 'image_svg_animate', 'image_svg_color', 'image_viewport_height']
            ], [
              'label' => 'Link', 
              'type' => 'group', 
              'divider' => true, 
