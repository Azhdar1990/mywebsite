<?php // $file = C:/xampp/htdocs/wordpress/wp-content/themes/yootheme/packages/builder/elements/popover/element.json
...
return [
  ...
  'fields' => [
    ...
    'css' => [
      ...
      'attrs' => [
        'debounce' => 500, 
        'hints' => ['.el-element', '.el-marker', '.el-item', '.el-title', '.el-meta', '.el-content', '.el-image', '.el-link']
      ]
    ], 
    ...
    'default' => [
      ...
      'fields' => [[
          ...
          'fields' => ['background_image', [
            ...
            ], 'background_image_alt', 'content', 'show_title', 'show_meta', 'show_content', 'show_image', 'show_link']
        ], [
          'title' => 'Settings', 
          'fields' => [[
              ...
              'type' => 'group', 
              'divider' => true, 
              'fields' => ['drop_position', 'drop_width', 'card_style', 'card_link', 'card_size']
            ], [
              'label' => 'Title', 
              'type' => 'group', 
              'divider' => true, 
              ...
              'fields' => [[
                ...
                ], 'image_card_padding', 'image_border', 'image_link', 'image_svg_inline', 'image_svg_animate', 'image_svg_color']
            ], [
              'label' => 'Link', 
              'type' => 'group', 
              'divider' => true, 
